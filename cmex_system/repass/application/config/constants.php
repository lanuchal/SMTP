...
define('HOST_URL','https://excellent.med.cmu.ac.th/'); 	//[on web server] //[ath][10/10/2565][add s]
define('HOST_URL_UES_IN_CON','http://excellent.med.cmu.ac.th/'); 	//[on web server] //[ath][12/10/2565][del /]
// define('HOST_URL','http://localhost:8888/');			//[on web localhost]
...
define("URL_IMG_EMP","https://excellent.med.cmu.ac.th/employee/images/person/"); //[ath][10/10/2565][add s]
