...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link">
      <img src="<?php echo base_url(); ?>../common/assets/images/logo_cmex.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 16px;">ระบบจัดการรหัสผ่าน</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <?php echo $numot; ?> -->
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url()."Repass/updateRepass/".$numot; ?>" class="nav-link">
          ...
          <!-- [Athiwat][01/06/2564][add comment] -->
          <!--<li class="nav-item has-treeview">
